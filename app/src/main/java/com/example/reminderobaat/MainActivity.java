...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mList = (RecyclerView) findViewById(R.id.pilihan);
        mNoReminderView = (TextView) findViewById(R.id.tulisan);
        ...
        mAddReminderButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(v.getContext(), Tambah_obat.class);
    ...
    public class SimpleAdapter extends RecyclerView.Adapter<SimpleAdapter.VerticalItemHolder> {
        ...
        public  class VerticalItemHolder extends SwappingHolder
            ...
            public void setReminderRepeatInfo(String repeat, String repeatNo, String repeatType) {
                if(repeat.equals("true")){
                    mRepeatInfoText.setText("Akan Berulang Setiap " + repeatNo + " " + repeatType + " ");
            ...
            public void setActiveImage(String active){
                if(active.equals("true")){
                    mActiveImage.setImageResource(R.drawable.alarmyes);
                }else if (active.equals("false")) {
                    mActiveImage.setImageResource(R.drawable.alarmno);
                }
            }
        }
        ...
        public List<ReminderItem> generateData(int count) {
            ...
            for (Reminder r : reminders) {
                Titles.add(r.getJudul());
                DateAndTime.add(r.getTanggal() + " " + r.getWaktu());
                Repeats.add(r.getPengulangan());
                RepeatNos.add(r.getInterval());
                RepeatTypes.add(r.getTipePengulangan());
                Actives.add(r.getAktif());
                IDList.add(r.getID());
            }
